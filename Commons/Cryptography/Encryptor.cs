...
namespace CaptchaDotNet2.Security.Cryptography
{
    ...
    public static class Encryptor
    {
        ...
        {
            return Encryptor.Encrypt(clearText, "srgerg$%^bg", Convert.FromBase64String("srfjuoxp"));
        }
        /// <summary>
        ...
        public static string Decrypt(string cipherText)
        {
            try
            {
                string v = Encryptor.Decrypt(cipherText, "srgerg$%^bg", Convert.FromBase64String("srfjuoxp"));
                return v;
            }
            catch
            {
